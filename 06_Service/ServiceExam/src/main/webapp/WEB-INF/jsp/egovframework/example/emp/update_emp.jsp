		...
		<form id="addForm" name="addForm" method="post">
			...
			<div class="mb3">
				<label for="ename" class="form-label">ename</label> <input
					type="text" class="form-control" id="ename" name="ename" value="<c:out value="${empVO.ename}"/>"
					placeholder="사원명">
			</div>
			...
			<div class="mb3">
				<label for="job" class="form-label">job</label> <input
					type="text" class="form-control" id="job" name="job" value="<c:out value="${empVO.job}"/>"
					placeholder="직위">
			</div>
			<!-- 부서위치(manager) -->
			<div class="mb3">
				<label for="manager" class="form-label">manager</label> <input type="text"
					class="form-control" id="manager" name="manager" value="<c:out value="${empVO.manager}"/>"  placeholder="관리자">
			</div>
			<!-- 버튼 추가 -->
			<div class="mb3">
