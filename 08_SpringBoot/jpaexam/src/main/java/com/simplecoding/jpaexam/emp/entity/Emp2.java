...
//TODO: 참조키 설정(*) : dno(컬럼명)
    ...
    private Dept2 dept2;                     // 부서엔티티 필드명

    //   예) Emp2 emp2=new Emp2();
    //      emp2.dept2.dno 값 조회
    //      emp2.dept2.dname 값 조회
    //    양방향 조인: 왜? => 부서에서 사원필드 조회하고 싶을 때 사용
    //     예) Dept2 dept2=new Dept2()
    //      dept2(부서에서 사원필드 조회하고 싶은데 못함)
