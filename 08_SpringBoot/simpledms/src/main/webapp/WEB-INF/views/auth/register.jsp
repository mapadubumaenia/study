            ...
            <div class="flex-vcenter">
                ...
                <div class="col2">
                    <div class="pt5 pl5 pb5 pr5">
                        ...
                        <form id="addForm" name="addForm" action="/auth/register/addition" method="post">
                            <%--csrf공격: 방어를 위해 csrf인증토큰이 필요--%>
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <%--TODO: 일반 권한(추가) : 권한명 추천: ROLE+아무이름,=> ROLE_USER(일반권한)  --%>
                            ...
                            <%--submit버튼 ==js submit()  같음=>js로 왜함? 그냥 타입 submit하면 끝인데 ㄹㅇㅋㅋ--%>
                            <button type="submit"
