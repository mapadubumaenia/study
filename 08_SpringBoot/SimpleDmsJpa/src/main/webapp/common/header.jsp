...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav">
        <li>
          <form id="search-Form" name="searchForm" action="/search" method="get" class="d-flex">
        ...
        <li>
          <form id="lookup-Form" name="lookupForm" action="/lookup" method="get" class="d-flex">
            <div class="input-group mb-3">
              <input type="text" class="form-control"
                     id="totalKeyword"
                     name="totalKeyword"
        ...
        <!-- {/* TODO: 로그인 시작 */} -->
        <!-- ROLE_ADMIN 권한이 있는 사람만 메뉴가 보이고, 없으면 안보임 -->
